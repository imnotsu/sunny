 ...
 * @author mathe
 */
public class DoarView extends javax.swing.JFrame {
    
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(DoarView.class.getName());

    /**
     * Creates new form DoarView
     */
    public DoarView() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons/dashboard/donation_pressed.png"))); // NOI18N
        ...
        jLabel1.setText("Desculpe, Indisponivel");

        jLabel7.setText("Devido a conflito com nossos sistemas, pedimos");

        jLabel10.setText("Para que todos que queiram doar se dirijam aos nossos funcionarios");

        jLabel12.setText("Para garantir a inscricao correta da doacao e a sua verificacao");

        jLabel14.setFont(new java.awt.Font("Poppins", 1, 18)); // NOI18N
        jLabel14.setText("Experimente ir até nós");

        jLabel15.setText("Rua Anjinho Aparecido - 7 - Sky Piea - São Paulo");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new DoarView().setVisible(true));
    }
